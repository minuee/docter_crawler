...
const crawlingCtrl = require(`${global.appRoot}/services/crawling_ansan.kumc.or.kr/controller`);
...
/**
 * @swagger
 *  /v1/c/ansan.kumc.or.kr/healthcheck:
 *    post:
 *      summary: "접속 테스트"
...
router.post('/step01', async function(req, res, next) {  
  ...
  const data = [];
  const r_url = `https://ansan.kumc.or.kr/kr/doctor-department/department.do`;
...
/**
 * @swagger
 *  /v1/c/ansan.kumc.or.kr/treatise:
 *    post:
 *      summary: "논문 조회"
 *      description: "고려대 안산병원 정보를 가져와야 한다  "
 *      tags: [ansan.kumc.or.kr-고려대 안산병원]
