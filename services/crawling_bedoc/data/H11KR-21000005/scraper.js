...
async function busanMedicalCenterScraper(doctorData) {
  ...
  try {
    ...
    const isExist = !$('body').text().includes('입력하신 정보와 일치하는 의료진이 없습니다');
    ...
    const scrapedData = {
      ...
      specialty: '', // Specialty field not obvious on the page
      education,
      experience,
...
module.exports = busanMedicalCenterScraper;
