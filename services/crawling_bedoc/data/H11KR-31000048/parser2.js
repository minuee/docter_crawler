...
(async () => {
  ...
  try {
    ...
    // Wait for the main content wrapper to ensure the page is ready for scraping
    await page.waitForSelector('.doctor_info_wrap', { timeout: 30000 });
    ...
    const doctorData = await page.evaluate(() => {
      ...
      data.학술 = extractSection('학회'); // The title is "학회 활동" but starts with "학회"
