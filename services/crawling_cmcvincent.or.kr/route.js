...
const crawlingCtrl = require(`${global.appRoot}/services/crawling_cmcvincent.or.kr/controller`);
...
/**
 * @swagger
 *  /v1/c/cmcvincent.or.kr/healthcheck:
 *    post:
 *      summary: "접속 테스트"
...
router.post('/step01', async function(req, res, next) {  
  ...
  const data = [];
  const r_url = `https://www.cmcvincent.or.kr/page/department/A`;
...
/**
 * @swagger
 *  /v1/c/cmcvincent.or.kr/treatise:
 *    post:
 *      summary: "논문 조회"
 *      description: "카톨릭대 성빈센트병원 정보를 가져와야 한다  "
 *      tags: [cmcvincent.or.kr-카톨릭대 성빈센트병원]
