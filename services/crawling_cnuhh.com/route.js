...
const crawlingCtrl = require(`${global.appRoot}/services/crawling_cnuhh.com/controller`);
...
router.post('/healthcheck', async function(req, res) {   
  const HOSPITAL_ID = 'H01KR-46000003';
...
/**
 * @swagger
 *  /v1/c/cnuhh.com/healthcheck:
 *    post:
 *      summary: "접속 테스트"
 *      description: "서버에 접속이 됬는데 "
 *      tags: [cnuhh.com - 화순전남대학교병원]
 *      produces:
 *      parameters:
 *        - name: "hid"
 *          in: "body"
...
router.post('/step01', async function(req, res, next) {  
  ...
  const data = [];
  const r_url = `https://www.cnuhh.com/medical/info/dept.cs`;
...
/**
 * @swagger
 *  /v1/c/cnuhh.com/step01:
 *    post:
 *      summary: "1단계  조회"
 *      description: "화순전남대학교병원 정보를 가져와야 한다  "
 *      tags: [cnuhh.com - 화순전남대학교병원]
 *      produces:
 *      parameters:
 *        - name: "hid"
